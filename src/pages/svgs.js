const BgImg = ( isNotMinWidth, radius, col1='#a6afff', col2='#f1345d', anim_t=20 ) =>
{
...
const Portrait = ()=>
{
   ...
   <style type="text/css">
      ...
      @keyframes support-fade {
         10%{ opacity: var(--target-opac); }
         70%{ opacity: var(--target-opac); }
      }
      #ArmL {
         opacity: var(--init-opac);
      ...
      @keyframes armL-fade {
         10%{ opacity: 0; }
         20%{ opacity: var(--target-opac); }
         80%{ opacity: var(--target-opac); }
      }
      #ArmR {
         opacity: var(--init-opac);
      ...
      @keyframes face-fade {
         27%{ opacity: 0; }
         37%{ opacity: var(--target-opac); }
         /* 45%{ opacity: var(--target-opac); }/
         60%{ opacity: var(--target-opac); }
      }
